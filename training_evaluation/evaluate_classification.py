...
def evaluate_classification_model(model, dataset, class_distribution, label_type, metrics, experiments_dir):
    ...
    """
    print("start evaluation of classification model")
    result_metrics = dict()
    ...
    f.savefig(os.path.join(experiments_dir, "confusion_matrix_relative.png"))
    #save_plot_to_artifacts(f, 'confusion_matrix_relative', experiments_dir)
    f = plot_confusion_matrix(np.array(mat), label_type, False)
    f.savefig(os.path.join(experiments_dir, "confusion_matrix.png"))
    #save_plot_to_artifacts(f, 'confusion_matrix', experiments_dir)
