...
```
    /run_files$ python train_model.py with ../testdata/test_config.yaml 
```
...
Additionally, a pretrained Inception-v03 needs to be downloaded for the desired patch image size and saved in ```models/```.
